				...
				<div>
					<div class="contact">
						<?php 
							...
							Print "<h3><span>$subject : Share file to teacher</span></h3>";
						?>
						<form method="post" enctype="multipart/form-data" action="getfile1.php">
							<table>
							<tr>
									<td><a href="studenttoteacherfiles.php">Click here to view all files sent to teacher</a></td>
								</tr>
								<tr>
								<input type="hidden" name="MAX_FILE_SIZE" value="2000000">
									<td><label for="email"><span>U</span>pload a <span>F</span>ile:</label></td>
									<td><input name="userfile" type="file" id="userfile"></td>
								</tr>
								<tr>
									<td><label for="message"><span>D</span>escription:</label></td>
