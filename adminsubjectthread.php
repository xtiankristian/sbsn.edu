				...
				<div>
					<div>
						...
						$subject = $_SESSION['subject'];
							Print "<h2>$subject : Teacher Discussion</h2>";
						?>
							<p><a href="adminreply.php?number=<?php Print"$number"?>">Click here to reply on thread</a></p>
							<?php
							$student = $number;
							...
							{ 
								...
								$comment = $result['main'];
								$user = $result['post_by'];
								Print "<p>Posted: " . $date ."<br/><br/> " .$comment ."<br/><br/> Posted by: ".$user."</p><br/><br/>";
							}
							?>
						</div>
					</div>
