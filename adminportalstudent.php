							...
							if($_SERVER['REQUEST_METHOD'] == "POST"){
								$sel = mysql_real_escape_string($_POST['sort']);
									if($sel == "Last Name"){
										...
										{
											Print '<li><p><a href="adminportalstudent2.php?number='.$result['username'].'&lname='.$result['lname'].'&fname='.$result['fname'].'&mname='.$result['mname'].'">'. $result['lname'] .", ". $result['fname']." " . $result['mname'] .'.</a></p></li>';
