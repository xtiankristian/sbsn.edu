				...
				<div>
					<div>
						<div class="section">
							...
							?>
							<p><a href="createexam.php">Create Online Exam</a></p>
							...
							{
								$quiz = $result1['quiz'];
								Print '<li><p><a href="adminexampreparation.php?quiz='.$quiz.'">'.$quiz.'</a></p>';
								Print '<br/><a href="publishquiz.php?quiz='.$quiz.'">Publish Quiz';
								Print '<br/><a href="unpublishquiz.php?quiz='.$quiz.'">Unublish Quiz';
								Print '<br/><a href="deletequiz.php?quiz='.$quiz.'">Delete Quiz</p></li>';
							}
								?>
									<?php
						...
						<div>
							<ul>
								<li>
								<div>
										<a href="annual.html" align="center"><span>Delete Annual Student Records</span></a>
								</div>
								</li>
								<li>
								<div>
