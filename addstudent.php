						...
						<div class="section">
							...
							$message = mysql_real_escape_string($_POST['search']);
										...
										while($result = mysql_fetch_array($query)) 
									{
										...
										Print '<a href="addstudentprocess.php?username='.$result['username'].'&lname='.$result['lname'].'&fname='.$result['fname'].'&mname='.$result['mname'].'&subject='.$subject.'" onClick="succ()">Add to list</a>';
										Print '</form>';
