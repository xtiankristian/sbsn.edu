					...
					<div class="about">
						...
						<?php
							...
							if($bt == "yes"){
								...
								{
									Print '<a href="quiznumber.php?number='.$e.'&time='.$taym.'">'.$e.'</a> | ';
									$e++;
								}
						...
						<?php
						if($two_ctr == true){
							Print '<form action="checkparagraph1.php" method="POST">';
							...
							Print '<form action="checkphrase1.php" method="POST">';
							Print '<input type="text" style="visibility: hidden" name="time" id="singleans" value=""><br/>';
							$ses = "q$q_id"."_ch$q_id";
							if(empty($_SESSION["$ses"])){
									$_SESSION["$ses"] = "";
							...
							Print '<form action="checkmultianswer1.php" method="POST">';
							...
							Print '<form action="checkcorrectanswers1.php" method="POST">';
							Print '<input type="text" style="visibility: hidden" name="time" id="singleans" value="">';
							$query = mysql_query("Select * FROM $answers where question_id = $q_id");
							$ay = "";
							while($result = mysql_fetch_array($query))
