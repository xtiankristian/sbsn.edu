...
<font face="Tahoma" size="30">SBSN Faculty Portal</font>
	<div class="ex" style="text-align:left">
	<img src="images/benedict_header.jpg"/>
		<form action="checklogin1.php" method="POST" style="text-align:center">
		...
		<button type="button" onclick="href()">Login as Aministrator</button>
