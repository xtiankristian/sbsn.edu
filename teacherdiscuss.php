				...
				<div>
					<div class="contact">
						<?php 
							...
							Print "<h3><span>$subject : Teacher Discussion</span></h3>";
						?>
						<form method="post" action="studenttoteacherchat.php">
							<table>
							<tr>
									<td><a href="subjectthread.php">Click here to view thread</a></td>
							</tr>
							<tr>
									<td><label for="message"><span>D</span>escription:</label></td><br/>
